...
--    
--   
--    Revision: 1.18 Thu Nov  8 11:03:42 2012 beq03196
--    Fix CR#82: CR - add bits for new OTG features
--
--    Revision: 1.17 Tue May  8 08:26:25 2012 beq03067
--    debug fpga not for rc
--
--    Revision: 1.16 Mon Feb 20 13:46:47 2012 beq03339
--    Added testmode input pin
--
--    Revision: 1.15 Fri Dec  2 15:58:02 2011 beq03196
--    add pin for fpga purpose only
--
--    Revision: 1.14 Wed Oct 12 14:18:27 2011 beq03067
--    Add phy_interface for FPGA
--
--    Revision: 1.13 Wed Oct  5 11:43:36 2011 beq03196
--    add ulpi_ddr_sel as input of the 3511_hs
--
--    Revision: 1.12 Wed Sep 21 07:21:55 2011 beq03067
--    debug 256 bits
--
--    Revision: 1.11 Mon Sep 12 16:52:39 2011 beq03196
--    replace sys_ahb_needclk to usb_need_clk according to arch doc.
--
--    Revision: 1.10 Mon Aug 29 11:08:00 2011 beq03196
...
--    added fpga debug
--
--    Revision: 1.6 Mon May 16 16:38:54 2011 beq03099
--    connected to dual-port RAM model
--
--    Revision: 1.5 Fri May 13 11:54:11 2011 beq03099
--    modified interface to be a ram interface instead of AHB master
--
--    Revision: 1.4 Fri May 13 11:17:46 2011 beq03196
--    -- Dedicated signals for internal PLL that is synchronized on USB frame time NOT USED FOR THE MOMENT
--
...
entity ip_xxx_3511_hs is
  ...
  port(
      ...
      -- USB_select_ext_clk:   out std_logic;
       ...
       -- C1 emergency-fallback chicken bit (see usb_pie_recovery_arb.e.vhdl
       -- ocp_path_disable_i): firmware-writable via DEVICE_RESET.
...
-- VSIA_Soft_IP_Tag % Vendor NXP B.V. % Product ip_3511_hs % Version 1.0 % Metric 0 % Date_Time 20100716 % IP_Owner CentralR&D/DS/MSS/Connectivity_Leuven % Celltype IP % Cell_Id ip_xxx_3511_hs % Signature 0 % Tag_Spec cru45
