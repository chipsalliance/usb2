...
// INDIRECT_FIFO_STATUS reports the implemented 64-DWORD storage depth and
// maximum transfer size. WRITE_INDEX and READ_INDEX are modulo-64 debug fields;
// FULL and EMPTY disambiguate equal indices.
localparam int OCP_FIFO_PHYSICAL_DEPTH_DWORDS = 64;
localparam int OCP_FIFO_RING_SIZE_DWORDS      = OCP_FIFO_PHYSICAL_DEPTH_DWORDS;
localparam int OCP_FIFO_MAX_TRANSFER_DWORDS   = 64;
localparam int OCP_FIFO_INDEX_MAX             = OCP_FIFO_RING_SIZE_DWORDS - 1;
