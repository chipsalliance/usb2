...
// 0.3      2026-09-11  Clayton  Four AXI interfaces with Combo target decode
// -------------------------------------------------------------------------
...
#(
  ...
  parameter bit C_DEV0_SINGLE_BUFFER_SUPPORTED = 1'b1,
  parameter bit C_DEV0_DOUBLE_BUFFER_SUPPORTED = 1'b1,
  parameter bit C_DEV0_TOGGLE_REG_READABLE = 1'b1,
  parameter bit C_DEV1_SINGLE_BUFFER_SUPPORTED = 1'b1,
  parameter bit C_DEV1_DOUBLE_BUFFER_SUPPORTED = 1'b1,
  parameter bit C_DEV1_TOGGLE_REG_READABLE = 1'b1,
  parameter bit C_PLL_ENABLE = 1'b0,
  parameter logic [6:0] C_PLL_DIVIDER = 7'b0010100,
  parameter bit C_ULPI_SUPPORT = 1'b1,
  parameter bit C_UTMI_SUPPORT = 1'b1,
  parameter bit C_EXTEND_TX_DELAY = 1'b1,
  ...
  logic [HUB_WORD_ADDR_WIDTH-1:0] hub_haddr;
  ...
  ip_xxx_3511_hs_mem_compound #(
    ...
    .C_DEV0_SINGLE_BUFFER_SUPPORTED(C_DEV0_SINGLE_BUFFER_SUPPORTED),
    .C_DEV0_DOUBLE_BUFFER_SUPPORTED(C_DEV0_DOUBLE_BUFFER_SUPPORTED),
    .C_DEV0_TOGGLE_REG_READABLE(C_DEV0_TOGGLE_REG_READABLE),
    .C_DEV1_SINGLE_BUFFER_SUPPORTED(C_DEV1_SINGLE_BUFFER_SUPPORTED),
    .C_DEV1_DOUBLE_BUFFER_SUPPORTED(C_DEV1_DOUBLE_BUFFER_SUPPORTED),
    .C_DEV1_TOGGLE_REG_READABLE(C_DEV1_TOGGLE_REG_READABLE),
