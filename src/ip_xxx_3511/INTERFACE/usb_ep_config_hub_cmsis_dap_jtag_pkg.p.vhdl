...
--  ----------------------------------------------------------------------------
--
--               File: usb_ep_config_hub_cmsis_dap_jtag_pkg.p.vhdl
--
...
constant C_DEV_LINK_START            : std_logic_vector(11 downto 0) := X"200";
constant C_NBDEV                     : integer := 2;  -- number of hardware devices (e.g hub + hid), software device is not included
constant C_NBPHYSEP_IN               : integer := 2;
